    ...
    <Layout 
      action={
        ...
        >
          ...
          <span className="hidden sm:inline">{t('home.add_account')}</span>
        </button>
      }
    >
      {/* Search Bar */}
      ...
      {accounts.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-slate-500 dark:text-slate-400 mb-4">{t('home.no_accounts')}</p>
          <button 
            onClick={() => setIsAddOpen(true)}
        ...
        <div className="text-center py-12">
          <p className="text-slate-500 dark:text-slate-400">{t('home.no_matches')}</p>
          <button 
            onClick={() => setSearchQuery('')}
