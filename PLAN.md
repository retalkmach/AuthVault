...
- [x] **搜索/过滤**: 快速查找账户
- [x] **UI/UX 优化**:
    - [x] **主题适配**: 支持亮色/暗色主题，并自动检测系统设置 (已适配 Tailwind v4)
- [x] **多语言支持 (i18n)**:
    - [x] **中文/英文**: 完整适配应用内文本
    - [x] **语言切换**: 设置页面支持实时切换
- [x] **设置页面**:
    - [x] **主题切换**: 支持手动切换亮色、暗色、系统
- [x] **导入导出**:
    - [x] **导出**: 将所有账户数据导出为 JSON 文件
    - [x] **导入**: 从 JSON 文件导入账户数据
- [x] **正式版本发布**:
    - [x] **v1.0.0**: 完成所有核心功能并修复已知问题
- [x] **生产环境构建**: 编译 Windows `exe` / `msi` (已验证构建流程)
